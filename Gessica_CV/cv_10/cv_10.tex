...
\header{Gessica}{Trivelli}{midwife} % Your name and current job title/field
...
\includegraphics[width=0.8\linewidth]{../FU2016}
\section{contact}
68, Aldo Moro
Comunanza (AP), 63087,
Italy
...
\entry
{2016--2017}
{Postgraduate Specialization {\normalfont for Midwifery}}
{Scuola Elementale di Arte Ostetrica, Florence}
{\emph{Pelvic floor's health in female cycle: education, prevention re-education and treatment of perineal dysfunction using a midwifery-led approach} \\ This thesis explored the idea that money has been the cause of untold anguish and suffering in the world. I found that it has, in fact, not.}
